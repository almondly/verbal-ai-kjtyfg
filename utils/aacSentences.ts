...
const ultraHighPrioritySentences: AACSentence[] = [
  ...
  // USER-PROVIDED PREBUILT SENTENCES - BATCH 4 (Priority 110 - HIGHEST)
  { text: 'It\'s so shiny', category: 'observations', context: 'visual observation', frequency: 'high', priority: 110 },
  { text: 'Can we go outside and look', category: 'questions', context: 'outdoor observation request', frequency: 'high', priority: 110 },
  { text: 'It\'s getting dark', category: 'observations', context: 'time observation', frequency: 'high', priority: 110 },
  { text: 'I can\'t see very well', category: 'statements', context: 'vision difficulty', frequency: 'high', priority: 110 },
  { text: 'Let\'s use a flashlight', category: 'suggestions', context: 'lighting solution', frequency: 'high', priority: 110 },
  { text: 'I hear crickets', category: 'observations', context: 'sound observation', frequency: 'high', priority: 110 },
  { text: 'It\'s peaceful here', category: 'feelings', context: 'calm environment', frequency: 'high', priority: 110 },
  { text: 'I like quiet moments', category: 'preferences', context: 'quiet preference', frequency: 'high', priority: 110 },
  { text: 'I feel calm', category: 'feelings', context: 'calmness', frequency: 'high', priority: 110 },
  { text: 'Breathing helps me relax', category: 'statements', context: 'relaxation technique', frequency: 'high', priority: 110 },
  { text: 'Let\'s count to ten together', category: 'activities', context: 'counting activity', frequency: 'high', priority: 110 },
  { text: 'I feel safe with you', category: 'feelings', context: 'safety', frequency: 'high', priority: 110 },
  { text: 'Can I tell you a secret', category: 'questions', context: 'secret sharing', frequency: 'high', priority: 110 },
  { text: 'Please don\'t tell anyone', category: 'requests', context: 'confidentiality request', frequency: 'high', priority: 110 },
  { text: 'I trust you', category: 'social', context: 'trust affirmation', frequency: 'high', priority: 110 },
  { text: 'That\'s a secret just for us', category: 'statements', context: 'shared secret', frequency: 'high', priority: 110 },
  { text: 'You can trust me too', category: 'social', context: 'trust reciprocation', frequency: 'high', priority: 110 },
  { text: 'I promise I won\'t tell', category: 'statements', context: 'promise', frequency: 'high', priority: 110 },
  { text: 'I didn\'t mean to break it', category: 'statements', context: 'accident explanation', frequency: 'high', priority: 110 },
  { text: 'I\'ll help fix it', category: 'statements', context: 'repair offer', frequency: 'high', priority: 110 },
  { text: 'I\'m sorry for the mistake', category: 'social', context: 'apology for error', frequency: 'high', priority: 110 },
  { text: 'Everyone makes mistakes', category: 'social', context: 'reassurance', frequency: 'high', priority: 110 },
  { text: 'Let\'s try again tomorrow', category: 'suggestions', context: 'future attempt', frequency: 'high', priority: 110 },
  { text: 'Tomorrow will be better', category: 'statements', context: 'optimism', frequency: 'high', priority: 110 },
  { text: 'I can\'t wait for the weekend', category: 'feelings', context: 'anticipation', frequency: 'high', priority: 110 },
  { text: 'What are you doing this weekend', category: 'questions', context: 'weekend plans inquiry', frequency: 'high', priority: 110 },
  { text: 'I want to go to the park', category: 'wants', context: 'park visit', frequency: 'high', priority: 110 },
  { text: 'Let\'s ride bikes', category: 'activities', context: 'bike riding', frequency: 'high', priority: 110 },
  { text: 'I want to go swimming', category: 'wants', context: 'swimming activity', frequency: 'high', priority: 110 },
  { text: 'I like going to the pool', category: 'preferences', context: 'pool preference', frequency: 'high', priority: 110 },
  { text: 'Don\'t splash me', category: 'requests', context: 'water play boundary', frequency: 'high', priority: 110 },
  { text: 'That was cold', category: 'observations', context: 'temperature reaction', frequency: 'high', priority: 110 },
  { text: 'Let\'s play a water game', category: 'activities', context: 'water play', frequency: 'high', priority: 110 },
  { text: 'I want to go to the beach', category: 'wants', context: 'beach visit', frequency: 'high', priority: 110 },
  { text: 'I love the ocean', category: 'preferences', context: 'ocean love', frequency: 'high', priority: 110 },
  { text: 'The waves are big', category: 'observations', context: 'wave observation', frequency: 'high', priority: 110 },
  { text: 'I like building sandcastles', category: 'activities', context: 'sandcastle building', frequency: 'high', priority: 110 },
  { text: 'I found a shell', category: 'statements', context: 'shell discovery', frequency: 'high', priority: 110 },
  { text: 'Look at this crab', category: 'statements', context: 'crab observation', frequency: 'high', priority: 110 },
  { text: 'I don\'t like seaweed', category: 'preferences', context: 'seaweed dislike', frequency: 'high', priority: 110 },
  { text: 'The sand is hot', category: 'observations', context: 'sand temperature', frequency: 'high', priority: 110 },
  { text: 'Can we get ice cream', category: 'questions', context: 'ice cream request', frequency: 'high', priority: 110 },
  { text: 'My favourite flavour is chocolate', category: 'preferences', context: 'ice cream preference', frequency: 'high', priority: 110 },
  { text: 'I like strawberry', category: 'preferences', context: 'strawberry preference', frequency: 'high', priority: 110 },
  { text: 'I like vanilla', category: 'preferences', context: 'vanilla preference', frequency: 'high', priority: 110 },
  { text: 'I don\'t like mint', category: 'preferences', context: 'mint dislike', frequency: 'high', priority: 110 },
  { text: 'That\'s melting fast', category: 'observations', context: 'melting observation', frequency: 'high', priority: 110 },
  { text: 'My hands are sticky', category: 'observations', context: 'sticky hands', frequency: 'high', priority: 110 },
  { text: 'I need to wash my hands', category: 'needs', context: 'hand washing', frequency: 'high', priority: 110 },
  { text: 'Where\'s the bathroom', category: 'questions', context: 'bathroom location', frequency: 'high', priority: 110 },
  { text: 'I need soap', category: 'needs', context: 'soap request', frequency: 'high', priority: 110 },
  { text: 'I\'m all clean now', category: 'statements', context: 'cleanliness', frequency: 'high', priority: 110 },
  { text: 'I smell nice', category: 'observations', context: 'pleasant smell', frequency: 'high', priority: 110 },
  { text: 'I need a towel', category: 'needs', context: 'towel request', frequency: 'high', priority: 110 },
  { text: 'Can you dry it for me', category: 'requests', context: 'drying assistance', frequency: 'high', priority: 110 },
  { text: 'I spilled water on my shirt', category: 'statements', context: 'spill accident', frequency: 'high', priority: 110 },
  { text: 'I need to change clothes', category: 'needs', context: 'clothing change', frequency: 'high', priority: 110 },
  { text: 'These are my favourite pants', category: 'preferences', context: 'clothing preference', frequency: 'high', priority: 110 },
  { text: 'I want to wear my hoodie', category: 'wants', context: 'hoodie preference', frequency: 'high', priority: 110 },
  { text: 'I like soft clothes', category: 'preferences', context: 'clothing texture', frequency: 'high', priority: 110 },
  { text: 'I don\'t like tags', category: 'sensory', context: 'tag sensitivity', frequency: 'high', priority: 110 },
  { text: 'This shirt is itchy', category: 'sensory', context: 'clothing discomfort', frequency: 'high', priority: 110 },
  { text: 'I like wearing my hat', category: 'preferences', context: 'hat preference', frequency: 'high', priority: 110 },
  { text: 'My shoes feel tight', category: 'observations', context: 'shoe fit', frequency: 'high', priority: 110 },
  { text: 'I need bigger shoes', category: 'needs', context: 'shoe size', frequency: 'high', priority: 110 },
  { text: 'I want to wear sandals', category: 'wants', context: 'sandal preference', frequency: 'high', priority: 110 },
  { text: 'I can\'t find my socks', category: 'statements', context: 'missing socks', frequency: 'high', priority: 110 },
  { text: 'I found them', category: 'statements', context: 'item found', frequency: 'high', priority: 110 },
  { text: 'I\'m ready now', category: 'statements', context: 'readiness', frequency: 'high', priority: 110 },
  { text: 'Let\'s go out', category: 'suggestions', context: 'departure', frequency: 'high', priority: 110 },
  { text: 'I forgot something', category: 'statements', context: 'forgotten item', frequency: 'high', priority: 110 },
  { text: 'I can\'t remember what it was', category: 'statements', context: 'memory difficulty', frequency: 'high', priority: 110 },
  { text: 'Oh, now I remember', category: 'statements', context: 'memory recall', frequency: 'high', priority: 110 },
  { text: 'I left it at home', category: 'statements', context: 'item location', frequency: 'high', priority: 110 },
  { text: 'I\'ll get it next time', category: 'statements', context: 'future retrieval', frequency: 'high', priority: 110 },
  { text: 'I don\'t mind waiting', category: 'statements', context: 'patience', frequency: 'high', priority: 110 },
  { text: 'Waiting is hard sometimes', category: 'feelings', context: 'impatience', frequency: 'high', priority: 110 },
  { text: 'What\'s taking so long', category: 'questions', context: 'delay inquiry', frequency: 'high', priority: 110 },
  { text: 'Almost done', category: 'statements', context: 'near completion', frequency: 'high', priority: 110 },
  { text: 'Let\'s do something while we wait', category: 'suggestions', context: 'waiting activity', frequency: 'high', priority: 110 },
  { text: 'I\'m getting impatient', category: 'feelings', context: 'impatience', frequency: 'high', priority: 110 },
  { text: 'Let\'s play a guessing game', category: 'activities', context: 'guessing game', frequency: 'high', priority: 110 },
  { text: 'I spy with my little eye', category: 'play', context: 'I spy game', frequency: 'high', priority: 110 },
  { text: 'It\'s something blue', category: 'statements', context: 'I spy clue', frequency: 'high', priority: 110 },
  { text: 'I know what it is', category: 'statements', context: 'guess confidence', frequency: 'high', priority: 110 },
  { text: 'You guessed it', category: 'statements', context: 'correct guess', frequency: 'high', priority: 110 },
  { text: 'That was a good guess', category: 'social', context: 'guess praise', frequency: 'high', priority: 110 },
  { text: 'Let\'s play another game', category: 'activities', context: 'game continuation', frequency: 'high', priority: 110 },
  { text: 'Your turn', category: 'statements', context: 'turn giving', frequency: 'high', priority: 110 },
  { text: 'My turn now', category: 'statements', context: 'turn claiming', frequency: 'high', priority: 110 },
  { text: 'Let\'s keep score', category: 'activities', context: 'score tracking', frequency: 'high', priority: 110 },
  { text: 'Who\'s winning', category: 'questions', context: 'score inquiry', frequency: 'high', priority: 110 },
  { text: 'I\'m catching up', category: 'statements', context: 'score progress', frequency: 'high', priority: 110 },
  { text: 'You\'re in the lead', category: 'statements', context: 'score observation', frequency: 'high', priority: 110 },
  { text: 'That was close', category: 'statements', context: 'close competition', frequency: 'high', priority: 110 },
  { text: 'It\'s a tie', category: 'statements', context: 'equal score', frequency: 'high', priority: 110 },
  { text: 'I\'m getting tired of this game', category: 'feelings', context: 'game boredom', frequency: 'high', priority: 110 },
  { text: 'Let\'s try something different', category: 'suggestions', context: 'activity change', frequency: 'high', priority: 110 },
  { text: 'I have an idea', category: 'statements', context: 'idea announcement', frequency: 'high', priority: 110 },
  { text: 'Let\'s make a new game', category: 'activities', context: 'game creation', frequency: 'high', priority: 110 },
  { text: 'We can make our own rules', category: 'statements', context: 'rule creation', frequency: 'high', priority: 110 },
  { text: 'That sounds fun', category: 'social', context: 'enthusiasm', frequency: 'high', priority: 110 },
  { text: 'Let\'s test it out', category: 'activities', context: 'testing', frequency: 'high', priority: 110 },
  { text: 'It worked', category: 'statements', context: 'success', frequency: 'high', priority: 110 },
  { text: 'We made a new game', category: 'statements', context: 'creation achievement', frequency: 'high', priority: 110 },
  { text: 'That\'s so creative', category: 'social', context: 'creativity praise', frequency: 'high', priority: 110 },
  { text: 'You\'re really clever', category: 'social', context: 'intelligence praise', frequency: 'high', priority: 110 },
  { text: 'I\'m proud of us', category: 'feelings', context: 'shared pride', frequency: 'high', priority: 110 },
  { text: 'Let\'s show the teacher', category: 'suggestions', context: 'sharing with teacher', frequency: 'high', priority: 110 },
  { text: 'They\'ll be so impressed', category: 'statements', context: 'anticipated reaction', frequency: 'high', priority: 110 },
  { text: 'We should write it down', category: 'suggestions', context: 'documentation', frequency: 'high', priority: 110 },
  { text: 'I\'ll draw a picture too', category: 'statements', context: 'drawing intention', frequency: 'high', priority: 110 },
  { text: 'It\'s our invention', category: 'statements', context: 'ownership', frequency: 'high', priority: 110 },
  { text: 'We can name it', category: 'statements', context: 'naming opportunity', frequency: 'high', priority: 110 },
  { text: 'Let\'s call it something funny', category: 'suggestions', context: 'humorous naming', frequency: 'high', priority: 110 },
  { text: 'That\'s a great name', category: 'social', context: 'name approval', frequency: 'high', priority: 110 },
  { text: 'Everyone will love it', category: 'statements', context: 'anticipated approval', frequency: 'high', priority: 110 },
  { text: 'I can\'t wait to show everyone', category: 'feelings', context: 'sharing excitement', frequency: 'high', priority: 110 },
  { text: 'You\'re awesome to work with', category: 'social', context: 'collaboration praise', frequency: 'high', priority: 110 },
  { text: 'Let\'s make something else next time', category: 'suggestions', context: 'future creation', frequency: 'high', priority: 110 },
  { text: 'What are we learning next', category: 'questions', context: 'lesson inquiry', frequency: 'high', priority: 110 },
  { text: 'I\'m ready to listen', category: 'statements', context: 'listening readiness', frequency: 'high', priority: 110 },
  { text: 'Can you write it on the board', category: 'requests', context: 'board writing request', frequency: 'high', priority: 110 },
  { text: 'I can\'t see the board', category: 'statements', context: 'visibility issue', frequency: 'high', priority: 110 },
  { text: 'My pencil broke', category: 'statements', context: 'broken pencil', frequency: 'high', priority: 110 },
  { text: 'Can I sharpen my pencil', category: 'questions', context: 'pencil sharpening', frequency: 'high', priority: 110 },
  { text: 'I lost my eraser', category: 'statements', context: 'missing eraser', frequency: 'high', priority: 110 },
  { text: 'I need some paper', category: 'needs', context: 'paper request', frequency: 'high', priority: 110 },
  { text: 'My desk is messy', category: 'observations', context: 'desk state', frequency: 'high', priority: 110 },
  { text: 'I\'ll clean it later', category: 'statements', context: 'future cleaning', frequency: 'high', priority: 110 },
  { text: 'I\'m done with my work', category: 'statements', context: 'work completion', frequency: 'high', priority: 110 },
  { text: 'Can I read a book now', category: 'questions', context: 'reading permission', frequency: 'high', priority: 110 },
  { text: 'What page are we on', category: 'questions', context: 'page inquiry', frequency: 'high', priority: 110 },
  { text: 'Can you read it again', category: 'requests', context: 'repeat reading', frequency: 'high', priority: 110 },
  { text: 'I like that story', category: 'preferences', context: 'story enjoyment', frequency: 'high', priority: 110 },
  { text: 'I didn\'t understand that part', category: 'statements', context: 'comprehension difficulty', frequency: 'high', priority: 110 },
  { text: 'Can you help me with this', category: 'requests', context: 'specific help', frequency: 'high', priority: 110 },
  { text: 'I think I got it now', category: 'statements', context: 'understanding', frequency: 'high', priority: 110 },
  { text: 'That makes sense', category: 'statements', context: 'comprehension', frequency: 'high', priority: 110 },
  { text: 'I\'m learning a lot', category: 'statements', context: 'learning progress', frequency: 'high', priority: 110 },
  { text: 'I like this lesson', category: 'preferences', context: 'lesson enjoyment', frequency: 'high', priority: 110 },
  { text: 'This is confusing', category: 'statements', context: 'confusion', frequency: 'high', priority: 110 },
  { text: 'I need more practice', category: 'needs', context: 'practice request', frequency: 'high', priority: 110 },
  { text: 'Can we go over it again', category: 'requests', context: 'review request', frequency: 'high', priority: 110 },
  { text: 'I\'ll remember it next time', category: 'statements', context: 'future memory', frequency: 'high', priority: 110 },
  { text: 'I have an idea for that', category: 'statements', context: 'idea contribution', frequency: 'high', priority: 110 },
  { text: 'That\'s a great question', category: 'social', context: 'question praise', frequency: 'high', priority: 110 },
  { text: 'I know the answer', category: 'statements', context: 'answer knowledge', frequency: 'high', priority: 110 },
