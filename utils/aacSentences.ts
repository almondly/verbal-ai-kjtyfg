...
const ultraHighPrioritySentences: AACSentence[] = [
  // USER-PROVIDED PREBUILT SENTENCES - BATCH 1 (Priority 110 - HIGHEST)
  ...
  { text: 'I\'m tired', category: 'needs', context: 'fatigue', frequency: 'high', priority: 110 },
  ...
  // USER-PROVIDED PREBUILT SENTENCES - BATCH 2 (Priority 110 - HIGHEST)
  { text: 'You took my turn', category: 'social', context: 'fairness concern', frequency: 'high', priority: 110 },
  { text: 'Let\'s try together', category: 'social', context: 'collaboration', frequency: 'high', priority: 110 },
  { text: 'I like your idea', category: 'social', context: 'compliment', frequency: 'high', priority: 110 },
  { text: 'That\'s a good answer', category: 'school', context: 'praise', frequency: 'high', priority: 110 },
  { text: 'You\'re really smart', category: 'social', context: 'compliment', frequency: 'high', priority: 110 },
  { text: 'I learned something new', category: 'school', context: 'learning achievement', frequency: 'high', priority: 110 },
  { text: 'Can you tell me more', category: 'questions', context: 'information request', frequency: 'high', priority: 110 },
  { text: 'I have a question', category: 'school', context: 'inquiry', frequency: 'high', priority: 110 },
  { text: 'What does that mean', category: 'questions', context: 'clarification', frequency: 'high', priority: 110 },
  { text: 'Why is that happening', category: 'questions', context: 'reasoning inquiry', frequency: 'high', priority: 110 },
  { text: 'Who is that', category: 'questions', context: 'person identification', frequency: 'high', priority: 110 },
  { text: 'Where are we going', category: 'questions', context: 'destination inquiry', frequency: 'high', priority: 110 },
  { text: 'When is it time', category: 'questions', context: 'timing inquiry', frequency: 'high', priority: 110 },
  { text: 'How do I do it', category: 'questions', context: 'instruction request', frequency: 'high', priority: 110 },
  { text: 'I want to know more', category: 'school', context: 'curiosity', frequency: 'high', priority: 110 },
  { text: 'That makes sense', category: 'school', context: 'understanding', frequency: 'high', priority: 110 },
  { text: 'I don\'t like loud sounds', category: 'sensory', context: 'auditory sensitivity', frequency: 'high', priority: 110 },
  { text: 'Can you turn it down', category: 'requests', context: 'volume reduction', frequency: 'high', priority: 110 },
  { text: 'That\'s too bright', category: 'sensory', context: 'visual sensitivity', frequency: 'high', priority: 110 },
  { text: 'I like quiet places', category: 'preferences', context: 'sensory preference', frequency: 'high', priority: 110 },
  { text: 'Can we go somewhere calm', category: 'requests', context: 'sensory regulation', frequency: 'high', priority: 110 },
  { text: 'Let\'s take a deep breath', category: 'actions', context: 'calming strategy', frequency: 'high', priority: 110 },
  { text: 'I feel nervous', category: 'feelings', context: 'anxiety', frequency: 'high', priority: 110 },
  { text: 'I\'m worried about that', category: 'feelings', context: 'concern', frequency: 'high', priority: 110 },
  { text: 'Everything will be okay', category: 'social', context: 'reassurance', frequency: 'high', priority: 110 },
  { text: 'I believe in myself', category: 'feelings', context: 'self-confidence', frequency: 'high', priority: 110 },
  { text: 'I can do hard things', category: 'statements', context: 'self-encouragement', frequency: 'high', priority: 110 },
  { text: 'Don\'t give up', category: 'social', context: 'encouragement', frequency: 'high', priority: 110 },
  { text: 'You\'re doing great', category: 'social', context: 'praise', frequency: 'high', priority: 110 },
  { text: 'I\'m proud of you', category: 'social', context: 'praise', frequency: 'high', priority: 110 },
  { text: 'That was really fun', category: 'social', context: 'enjoyment', frequency: 'high', priority: 110 },
  { text: 'I want to do it again', category: 'wants', context: 'repeat activity', frequency: 'high', priority: 110 },
  { text: 'I need a hug', category: 'sensory', context: 'physical comfort', frequency: 'high', priority: 110 },
  { text: 'Can I have a hug', category: 'requests', context: 'physical comfort', frequency: 'high', priority: 110 },
  { text: 'I like hugs', category: 'preferences', context: 'physical comfort', frequency: 'high', priority: 110 },
  { text: 'Please don\'t touch me', category: 'requests', context: 'personal boundaries', frequency: 'high', priority: 110 },
  { text: 'I need some alone time', category: 'needs', context: 'personal space', frequency: 'high', priority: 110 },
  { text: 'I\'m feeling overwhelmed', category: 'feelings', context: 'sensory overload', frequency: 'high', priority: 110 },
  { text: 'Can we take a break', category: 'requests', context: 'pause request', frequency: 'high', priority: 110 },
  { text: 'I need quiet time', category: 'needs', context: 'sensory regulation', frequency: 'high', priority: 110 },
  { text: 'Let\'s go for a walk', category: 'activities', context: 'outdoor activity', frequency: 'high', priority: 110 },
  { text: 'I want to listen to music', category: 'wants', context: 'music activity', frequency: 'high', priority: 110 },
  { text: 'Can we draw together', category: 'questions', context: 'art activity', frequency: 'high', priority: 110 },
  { text: 'I like art class', category: 'school', context: 'subject preference', frequency: 'high', priority: 110 },
  { text: 'I like science', category: 'school', context: 'subject preference', frequency: 'high', priority: 110 },
  { text: 'I like doing experiments', category: 'school', context: 'activity preference', frequency: 'high', priority: 110 },
  { text: 'What are we learning today', category: 'school', context: 'lesson inquiry', frequency: 'high', priority: 110 },
  { text: 'Can I help with that', category: 'questions', context: 'assistance offer', frequency: 'high', priority: 110 },
  { text: 'I finished my work', category: 'school', context: 'task completion', frequency: 'high', priority: 110 },
  { text: 'I need more time', category: 'school', context: 'pacing request', frequency: 'high', priority: 110 },
  { text: 'I\'m not done yet', category: 'statements', context: 'work in progress', frequency: 'high', priority: 110 },
  { text: 'That\'s my favourite subject', category: 'school', context: 'subject preference', frequency: 'high', priority: 110 },
  { text: 'I don\'t like this subject', category: 'school', context: 'subject dislike', frequency: 'high', priority: 110 },
  { text: 'This is too easy', category: 'school', context: 'difficulty assessment', frequency: 'high', priority: 110 },
  { text: 'This is too hard', category: 'school', context: 'difficulty assessment', frequency: 'high', priority: 110 },
  { text: 'Can you make it easier', category: 'requests', context: 'difficulty adjustment', frequency: 'high', priority: 110 },
  { text: 'Can we do something else', category: 'questions', context: 'activity change', frequency: 'high', priority: 110 },
  { text: 'Let\'s try something new', category: 'actions', context: 'new activity', frequency: 'high', priority: 110 },
  { text: 'That was a great idea', category: 'social', context: 'praise', frequency: 'high', priority: 110 },
  { text: 'I like how you did that', category: 'social', context: 'compliment', frequency: 'high', priority: 110 },
  { text: 'I made a mistake', category: 'statements', context: 'error acknowledgment', frequency: 'high', priority: 110 },
  { text: 'It\'s okay to make mistakes', category: 'social', context: 'reassurance', frequency: 'high', priority: 110 },
  { text: 'I\'ll do better next time', category: 'statements', context: 'self-improvement', frequency: 'high', priority: 110 },
  { text: 'Can we fix it', category: 'questions', context: 'problem solving', frequency: 'high', priority: 110 },
  { text: 'Let\'s work together', category: 'social', context: 'collaboration', frequency: 'high', priority: 110 },
  { text: 'You can help me', category: 'social', context: 'assistance request', frequency: 'high', priority: 110 },
  { text: 'I\'ll help you', category: 'social', context: 'assistance offer', frequency: 'high', priority: 110 },
  { text: 'We\'re a good team', category: 'social', context: 'teamwork affirmation', frequency: 'high', priority: 110 },
  { text: 'Let\'s take turns talking', category: 'social', context: 'conversation management', frequency: 'high', priority: 110 },
  { text: 'I have something to say', category: 'social', context: 'communication intent', frequency: 'high', priority: 110 },
  { text: 'Please listen to me', category: 'requests', context: 'attention request', frequency: 'high', priority: 110 },
  { text: 'Can you listen', category: 'requests', context: 'attention request', frequency: 'high', priority: 110 },
  { text: 'I wasn\'t finished', category: 'statements', context: 'interruption response', frequency: 'high', priority: 110 },
  { text: 'Let me finish my thought', category: 'requests', context: 'completion request', frequency: 'high', priority: 110 },
  { text: 'That\'s what I meant', category: 'statements', context: 'clarification', frequency: 'high', priority: 110 },
  { text: 'I like talking with you', category: 'social', context: 'social enjoyment', frequency: 'high', priority: 110 },
  { text: 'You make me laugh', category: 'social', context: 'positive feedback', frequency: 'high', priority: 110 },
  { text: 'That\'s really funny', category: 'social', context: 'amusement', frequency: 'high', priority: 110 },
  { text: 'I didn\'t mean to do that', category: 'statements', context: 'accident explanation', frequency: 'high', priority: 110 },
  { text: 'I\'m trying to be careful', category: 'statements', context: 'effort acknowledgment', frequency: 'high', priority: 110 },
  { text: 'That was an accident', category: 'statements', context: 'accident explanation', frequency: 'high', priority: 110 },
  { text: 'Can I try again', category: 'questions', context: 'second attempt', frequency: 'high', priority: 110 },
  { text: 'I want to learn more', category: 'school', context: 'learning desire', frequency: 'high', priority: 110 },
  { text: 'What do you think', category: 'questions', context: 'opinion request', frequency: 'high', priority: 110 },
  { text: 'That\'s a good point', category: 'social', context: 'agreement', frequency: 'high', priority: 110 },
  { text: 'I agree', category: 'responses', context: 'agreement', frequency: 'high', priority: 110 },
  { text: 'I disagree', category: 'responses', context: 'disagreement', frequency: 'high', priority: 110 },
  { text: 'Maybe you\'re right', category: 'responses', context: 'consideration', frequency: 'high', priority: 110 },
  { text: 'Let\'s ask the teacher', category: 'school', context: 'seeking guidance', frequency: 'high', priority: 110 },
  { text: 'I\'m ready to start', category: 'statements', context: 'readiness', frequency: 'high', priority: 110 },
  { text: 'Can we begin', category: 'questions', context: 'activity initiation', frequency: 'high', priority: 110 },
  { text: 'What are we doing next', category: 'questions', context: 'sequence inquiry', frequency: 'high', priority: 110 },
  { text: 'I\'m done for today', category: 'statements', context: 'completion', frequency: 'high', priority: 110 },
  { text: 'Can I go now', category: 'questions', context: 'departure permission', frequency: 'high', priority: 110 },
  { text: 'I want to stay a bit longer', category: 'wants', context: 'time extension', frequency: 'high', priority: 110 },
  { text: 'It\'s time to pack up', category: 'routines', context: 'cleanup time', frequency: 'high', priority: 110 },
  { text: 'I\'m ready to go home', category: 'statements', context: 'departure readiness', frequency: 'high', priority: 110 },
  { text: 'I had a good day', category: 'statements', context: 'positive reflection', frequency: 'high', priority: 110 },
  { text: 'I had a hard day', category: 'statements', context: 'difficult reflection', frequency: 'high', priority: 110 },
  { text: 'Today was okay', category: 'statements', context: 'neutral reflection', frequency: 'high', priority: 110 },
  { text: 'I liked today', category: 'statements', context: 'positive reflection', frequency: 'high', priority: 110 },
  { text: 'I didn\'t like today', category: 'statements', context: 'negative reflection', frequency: 'high', priority: 110 },
  { text: 'I made new friends', category: 'social', context: 'friendship formation', frequency: 'high', priority: 110 },
  { text: 'I missed my friends', category: 'feelings', context: 'social longing', frequency: 'high', priority: 110 },
  { text: 'Who wants to play', category: 'questions', context: 'play invitation', frequency: 'high', priority: 110 },
  { text: 'Let\'s go to the playground', category: 'activities', context: 'outdoor play', frequency: 'high', priority: 110 },
  { text: 'Can you push me on the swing', category: 'requests', context: 'playground assistance', frequency: 'high', priority: 110 },
  { text: 'I want to go higher', category: 'wants', context: 'swing activity', frequency: 'high', priority: 110 },
  { text: 'I\'m scared of heights', category: 'feelings', context: 'fear', frequency: 'high', priority: 110 },
  { text: 'I like sliding down', category: 'preferences', context: 'playground activity', frequency: 'high', priority: 110 },
  { text: 'Let\'s run', category: 'activities', context: 'physical activity', frequency: 'high', priority: 110 },
  { text: 'That was fast', category: 'statements', context: 'speed observation', frequency: 'high', priority: 110 },
  { text: 'I\'m tired now', category: 'feelings', context: 'fatigue', frequency: 'high', priority: 110 },
  { text: 'Can we rest', category: 'requests', context: 'rest request', frequency: 'high', priority: 110 },
  { text: 'I need to sit down', category: 'needs', context: 'rest request', frequency: 'high', priority: 110 },
  { text: 'My legs hurt', category: 'health', context: 'pain location', frequency: 'high', priority: 110 },
  { text: 'Let\'s drink some water', category: 'activities', context: 'hydration', frequency: 'high', priority: 110 },
  { text: 'I feel hot', category: 'sensory', context: 'temperature discomfort', frequency: 'high', priority: 110 },
  { text: 'It\'s so sunny', category: 'observations', context: 'weather observation', frequency: 'high', priority: 110 },
  { text: 'I forgot my hat', category: 'statements', context: 'missing item', frequency: 'high', priority: 110 },
  { text: 'I need sunscreen', category: 'needs', context: 'sun protection', frequency: 'high', priority: 110 },
  { text: 'It\'s raining', category: 'observations', context: 'weather observation', frequency: 'high', priority: 110 },
  { text: 'I love the rain', category: 'preferences', context: 'weather preference', frequency: 'high', priority: 110 },
  { text: 'I don\'t like getting wet', category: 'preferences', context: 'sensory preference', frequency: 'high', priority: 110 },
  { text: 'It\'s too windy', category: 'sensory', context: 'weather discomfort', frequency: 'high', priority: 110 },
  { text: 'It\'s cold outside', category: 'sensory', context: 'temperature observation', frequency: 'high', priority: 110 },
  { text: 'I need my jacket', category: 'needs', context: 'clothing request', frequency: 'high', priority: 110 },
  { text: 'I forgot my jumper', category: 'statements', context: 'missing clothing', frequency: 'high', priority: 110 },
  { text: 'Can you zip it up', category: 'requests', context: 'clothing assistance', frequency: 'high', priority: 110 },
  { text: 'My shoes are untied', category: 'statements', context: 'clothing issue', frequency: 'high', priority: 110 },
  { text: 'I can tie them myself', category: 'statements', context: 'independence', frequency: 'high', priority: 110 },
  { text: 'I can\'t reach it', category: 'statements', context: 'assistance need', frequency: 'high', priority: 110 },
  { text: 'Please hand it to me', category: 'requests', context: 'object request', frequency: 'high', priority: 110 },
  { text: 'Be careful', category: 'social', context: 'safety warning', frequency: 'high', priority: 110 },
  { text: 'Watch out', category: 'social', context: 'safety warning', frequency: 'high', priority: 110 },
  { text: 'That\'s dangerous', category: 'statements', context: 'safety concern', frequency: 'high', priority: 110 },
  { text: 'Don\'t touch that', category: 'requests', context: 'safety warning', frequency: 'high', priority: 110 },
  { text: 'Can you hold my hand', category: 'requests', context: 'safety request', frequency: 'high', priority: 110 },
  { text: 'I\'m scared of the dark', category: 'feelings', context: 'fear', frequency: 'high', priority: 110 },
  { text: 'Please turn on the light', category: 'requests', context: 'lighting request', frequency: 'high', priority: 110 },
  { text: 'It\'s too bright', category: 'sensory', context: 'visual sensitivity', frequency: 'high', priority: 110 },
  { text: 'Close the door, please', category: 'requests', context: 'door request', frequency: 'high', priority: 110 },
  { text: 'Open the window', category: 'requests', context: 'window request', frequency: 'high', priority: 110 },
  { text: 'It\'s stuffy in here', category: 'sensory', context: 'air quality', frequency: 'high', priority: 110 },
  { text: 'I can\'t hear you', category: 'statements', context: 'hearing difficulty', frequency: 'high', priority: 110 },
  { text: 'Speak louder, please', category: 'requests', context: 'volume request', frequency: 'high', priority: 110 },
  { text: 'Can you whisper', category: 'requests', context: 'volume reduction', frequency: 'high', priority: 110 },
  { text: 'That sound hurts my ears', category: 'sensory', context: 'auditory sensitivity', frequency: 'high', priority: 110 },
  { text: 'I like soft sounds', category: 'preferences', context: 'auditory preference', frequency: 'high', priority: 110 },
  { text: 'I like music time', category: 'preferences', context: 'activity preference', frequency: 'high', priority: 110 },
  { text: 'Let\'s sing together', category: 'activities', context: 'music activity', frequency: 'high', priority: 110 },
  { text: 'That\'s my favourite song', category: 'preferences', context: 'music preference', frequency: 'high', priority: 110 },
  { text: 'I know this one', category: 'statements', context: 'recognition', frequency: 'high', priority: 110 },
  { text: 'Can we dance', category: 'questions', context: 'dance activity', frequency: 'high', priority: 110 },
  { text: 'That was awesome', category: 'social', context: 'positive reaction', frequency: 'high', priority: 110 },
  { text: 'I love that part', category: 'preferences', context: 'specific enjoyment', frequency: 'high', priority: 110 },
  { text: 'Let\'s do it again', category: 'activities', context: 'repeat activity', frequency: 'high', priority: 110 },
  { text: 'I\'m getting sleepy', category: 'feelings', context: 'tiredness', frequency: 'high', priority: 110 },
  
  // USER-PROVIDED PREBUILT SENTENCES - BATCH 3 (Priority 110 - HIGHEST)
  { text: 'I want to go to bed', category: 'routines', context: 'bedtime request', frequency: 'high', priority: 110 },
  { text: 'Can you read me a story', category: 'activities', context: 'story request', frequency: 'high', priority: 110 },
  { text: 'That\'s my favourite book', category: 'preferences', context: 'book preference', frequency: 'high', priority: 110 },
  { text: 'Can we read another one', category: 'questions', context: 'story continuation', frequency: 'high', priority: 110 },
  { text: 'I like that character', category: 'preferences', context: 'character preference', frequency: 'high', priority: 110 },
  { text: 'What happens next', category: 'questions', context: 'story inquiry', frequency: 'high', priority: 110 },
  { text: 'The story was funny', category: 'statements', context: 'story reaction', frequency: 'high', priority: 110 },
  { text: 'The ending made me sad', category: 'feelings', context: 'emotional reaction', frequency: 'high', priority: 110 },
  { text: 'I like happy endings', category: 'preferences', context: 'story preference', frequency: 'high', priority: 110 },
  { text: 'That scared me a little', category: 'feelings', context: 'mild fear', frequency: 'high', priority: 110 },
  { text: 'I like mysteries', category: 'preferences', context: 'genre preference', frequency: 'high', priority: 110 },
  { text: 'Let\'s make up a story', category: 'activities', context: 'creative storytelling', frequency: 'high', priority: 110 },
  { text: 'Once upon a time', category: 'statements', context: 'story beginning', frequency: 'high', priority: 110 },
  { text: 'That\'s a great story', category: 'social', context: 'story praise', frequency: 'high', priority: 110 },
  { text: 'I like pretending', category: 'play', context: 'imaginative play', frequency: 'high', priority: 110 },
  { text: 'Let\'s play pretend', category: 'play', context: 'imaginative play invitation', frequency: 'high', priority: 110 },
  { text: 'I\'ll be the teacher', category: 'play', context: 'role assignment', frequency: 'high', priority: 110 },
  { text: 'You be the student', category: 'play', context: 'role assignment', frequency: 'high', priority: 110 },
  { text: 'I\'m the doctor', category: 'play', context: 'role assignment', frequency: 'high', priority: 110 },
  { text: 'You\'re the patient', category: 'play', context: 'role assignment', frequency: 'high', priority: 110 },
  { text: 'I\'m the superhero', category: 'play', context: 'role assignment', frequency: 'high', priority: 110 },
  { text: 'Let\'s save the day', category: 'play', context: 'imaginative play action', frequency: 'high', priority: 110 },
  { text: 'We did it', category: 'statements', context: 'achievement celebration', frequency: 'high', priority: 110 },
  { text: 'That was fun', category: 'social', context: 'enjoyment reflection', frequency: 'high', priority: 110 },
  { text: 'Let\'s clean up the toys', category: 'routines', context: 'cleanup activity', frequency: 'high', priority: 110 },
  { text: 'Can you help me tidy up', category: 'requests', context: 'cleanup assistance', frequency: 'high', priority: 110 },
  { text: 'I\'m almost done cleaning', category: 'statements', context: 'cleanup progress', frequency: 'high', priority: 110 },
  { text: 'Everything looks nice now', category: 'statements', context: 'cleanup completion', frequency: 'high', priority: 110 },
  { text: 'Where does this go', category: 'questions', context: 'organization inquiry', frequency: 'high', priority: 110 },
  { text: 'It doesn\'t fit', category: 'statements', context: 'size problem', frequency: 'high', priority: 110 },
  { text: 'I dropped it', category: 'statements', context: 'accident', frequency: 'high', priority: 110 },
  { text: 'It broke', category: 'statements', context: 'damage', frequency: 'high', priority: 110 },
  { text: 'Can you fix it', category: 'requests', context: 'repair request', frequency: 'high', priority: 110 },
  { text: 'I\'ll fix it myself', category: 'statements', context: 'independent repair', frequency: 'high', priority: 110 },
  { text: 'It\'s working again', category: 'statements', context: 'repair success', frequency: 'high', priority: 110 },
  { text: 'It still doesn\'t work', category: 'statements', context: 'repair failure', frequency: 'high', priority: 110 },
  { text: 'That\'s confusing', category: 'statements', context: 'confusion', frequency: 'high', priority: 110 },
  { text: 'Let\'s figure it out', category: 'actions', context: 'problem solving', frequency: 'high', priority: 110 },
  { text: 'I think I know how', category: 'statements', context: 'understanding', frequency: 'high', priority: 110 },
  { text: 'I\'m not sure', category: 'statements', context: 'uncertainty', frequency: 'high', priority: 110 },
  { text: 'I guessed right', category: 'statements', context: 'correct guess', frequency: 'high', priority: 110 },
  { text: 'That\'s the answer', category: 'statements', context: 'solution found', frequency: 'high', priority: 110 },
  { text: 'Oops, that was wrong', category: 'statements', context: 'error acknowledgment', frequency: 'high', priority: 110 },
  { text: 'It\'s fine, I\'ll try again', category: 'statements', context: 'persistence', frequency: 'high', priority: 110 },
  { text: 'I like puzzles', category: 'preferences', context: 'puzzle interest', frequency: 'high', priority: 110 },
  { text: 'This one\'s tricky', category: 'statements', context: 'difficulty assessment', frequency: 'high', priority: 110 },
  { text: 'I did it by myself', category: 'statements', context: 'independent achievement', frequency: 'high', priority: 110 },
  { text: 'Let\'s celebrate', category: 'social', context: 'celebration invitation', frequency: 'high', priority: 110 },
  { text: 'High five', category: 'social', context: 'celebration gesture', frequency: 'high', priority: 110 },
  { text: 'That was awesome teamwork', category: 'social', context: 'teamwork praise', frequency: 'high', priority: 110 },
  { text: 'You\'re the best', category: 'social', context: 'compliment', frequency: 'high', priority: 110 },
  { text: 'Thanks for helping me', category: 'social', context: 'gratitude', frequency: 'high', priority: 110 },
  { text: 'You\'re welcome anytime', category: 'social', context: 'hospitality', frequency: 'high', priority: 110 },
  { text: 'I like spending time with you', category: 'social', context: 'affection', frequency: 'high', priority: 110 },
  { text: 'You make me happy', category: 'feelings', context: 'happiness attribution', frequency: 'high', priority: 110 },
  { text: 'I feel loved', category: 'feelings', context: 'affection', frequency: 'high', priority: 110 },
  { text: 'You\'re my best friend', category: 'social', context: 'friendship affirmation', frequency: 'high', priority: 110 },
  { text: 'Can we sit together', category: 'questions', context: 'proximity request', frequency: 'high', priority: 110 },
  { text: 'Let\'s have lunch together', category: 'social', context: 'meal invitation', frequency: 'high', priority: 110 },
  { text: 'What\'s your favourite food', category: 'questions', context: 'food preference inquiry', frequency: 'high', priority: 110 },
  { text: 'Mine is pizza', category: 'statements', context: 'food preference', frequency: 'high', priority: 110 },
  { text: 'I like spaghetti', category: 'food', context: 'food preference', frequency: 'high', priority: 110 },
  { text: 'I don\'t like vegetables', category: 'food', context: 'food dislike', frequency: 'high', priority: 110 },
  { text: 'I\'ll try a little bit', category: 'statements', context: 'willingness to try', frequency: 'high', priority: 110 },
  { text: 'I can\'t wait for recess', category: 'school', context: 'anticipation', frequency: 'high', priority: 110 },
  { text: 'Can we sit together at lunch', category: 'questions', context: 'lunch seating', frequency: 'high', priority: 110 },
  { text: 'I forgot my lunch', category: 'school', context: 'missing lunch', frequency: 'high', priority: 110 },
  { text: 'I packed my lunch today', category: 'school', context: 'lunch prepared', frequency: 'high', priority: 110 },
  { text: 'I like your sandwich', category: 'social', context: 'food compliment', frequency: 'high', priority: 110 },
  { text: 'That smells good', category: 'observations', context: 'smell observation', frequency: 'high', priority: 110 },
  { text: 'Can we trade snacks', category: 'questions', context: 'snack exchange', frequency: 'high', priority: 110 },
  { text: 'I\'m not hungry right now', category: 'food', context: 'lack of hunger', frequency: 'high', priority: 110 },
  { text: 'Can I save it for later', category: 'questions', context: 'food saving', frequency: 'high', priority: 110 },
  { text: 'I dropped my food', category: 'statements', context: 'food accident', frequency: 'high', priority: 110 },
  { text: 'Can you help me clean it up', category: 'requests', context: 'cleanup assistance', frequency: 'high', priority: 110 },
  { text: 'It made a mess', category: 'statements', context: 'mess observation', frequency: 'high', priority: 110 },
  { text: 'I spilled my drink again', category: 'statements', context: 'drink accident', frequency: 'high', priority: 110 },
  { text: 'I\'ll be more careful next time', category: 'statements', context: 'future intention', frequency: 'high', priority: 110 },
  { text: 'It\'s okay, accidents happen', category: 'social', context: 'reassurance', frequency: 'high', priority: 110 },
  { text: 'I feel embarrassed', category: 'feelings', context: 'embarrassment', frequency: 'high', priority: 110 },
  { text: 'Please don\'t laugh at me', category: 'requests', context: 'respect request', frequency: 'high', priority: 110 },
  { text: 'That hurt my feelings', category: 'feelings', context: 'emotional hurt', frequency: 'high', priority: 110 },
  { text: 'You made me smile', category: 'social', context: 'positive feedback', frequency: 'high', priority: 110 },
  { text: 'You make me laugh every day', category: 'social', context: 'appreciation', frequency: 'high', priority: 110 },
  { text: 'That was really kind of you', category: 'social', context: 'kindness recognition', frequency: 'high', priority: 110 },
  { text: 'I want to be kind too', category: 'statements', context: 'kindness intention', frequency: 'high', priority: 110 },
  { text: 'I\'m trying my best to be nice', category: 'statements', context: 'effort acknowledgment', frequency: 'high', priority: 110 },
  { text: 'Sometimes I get upset easily', category: 'feelings', context: 'emotional sensitivity', frequency: 'high', priority: 110 },
  { text: 'I didn\'t mean to shout', category: 'statements', context: 'apology explanation', frequency: 'high', priority: 110 },
  { text: 'I just needed space', category: 'statements', context: 'space explanation', frequency: 'high', priority: 110 },
  { text: 'I\'m calm now', category: 'feelings', context: 'emotional regulation', frequency: 'high', priority: 110 },
  { text: 'Can we talk about it', category: 'questions', context: 'communication request', frequency: 'high', priority: 110 },
  { text: 'I want to say sorry', category: 'social', context: 'apology intention', frequency: 'high', priority: 110 },
  { text: 'Thank you for understanding', category: 'social', context: 'gratitude for empathy', frequency: 'high', priority: 110 },
  { text: 'I feel better now', category: 'feelings', context: 'emotional improvement', frequency: 'high', priority: 110 },
  { text: 'That made me happy again', category: 'feelings', context: 'happiness restoration', frequency: 'high', priority: 110 },
  { text: 'You\'re a good friend', category: 'social', context: 'friendship affirmation', frequency: 'high', priority: 110 },
  { text: 'I like being around you', category: 'social', context: 'social enjoyment', frequency: 'high', priority: 110 },
  { text: 'I like making new friends', category: 'social', context: 'friendship interest', frequency: 'high', priority: 110 },
  { text: 'I\'m nervous to talk to new people', category: 'feelings', context: 'social anxiety', frequency: 'high', priority: 110 },
  { text: 'What\'s your name', category: 'questions', context: 'name inquiry', frequency: 'high', priority: 110 },
  { text: 'Nice to meet you', category: 'social', context: 'greeting', frequency: 'high', priority: 110 },
  { text: 'Do you want to play', category: 'questions', context: 'play invitation', frequency: 'high', priority: 110 },
  { text: 'What game should we play', category: 'questions', context: 'game selection', frequency: 'high', priority: 110 },
  { text: 'I like playing tag', category: 'play', context: 'game preference', frequency: 'high', priority: 110 },
  { text: 'Let\'s build a fort', category: 'play', context: 'construction play', frequency: 'high', priority: 110 },
  { text: 'What colour should we use', category: 'questions', context: 'colour selection', frequency: 'high', priority: 110 },
  { text: 'Let\'s make it rainbow', category: 'activities', context: 'colour choice', frequency: 'high', priority: 110 },
  { text: 'That looks amazing', category: 'social', context: 'praise', frequency: 'high', priority: 110 },
  { text: 'I\'m proud of our art', category: 'feelings', context: 'pride in creation', frequency: 'high', priority: 110 },
  { text: 'Can we hang it up', category: 'questions', context: 'display request', frequency: 'high', priority: 110 },
  { text: 'It\'s picture day', category: 'statements', context: 'school event', frequency: 'high', priority: 110 },
  { text: 'I forgot to smile', category: 'statements', context: 'photo concern', frequency: 'high', priority: 110 },
  { text: 'Let\'s take another one', category: 'requests', context: 'photo retake', frequency: 'high', priority: 110 },
  { text: 'I blinked', category: 'statements', context: 'photo problem', frequency: 'high', priority: 110 },
  { text: 'That one\'s funny', category: 'social', context: 'photo reaction', frequency: 'high', priority: 110 },
  { text: 'I love photos', category: 'preferences', context: 'photo interest', frequency: 'high', priority: 110 },
  { text: 'Can we take a selfie', category: 'questions', context: 'photo request', frequency: 'high', priority: 110 },
  { text: 'I want to show my family', category: 'statements', context: 'sharing intention', frequency: 'high', priority: 110 },
  { text: 'My family makes me happy', category: 'feelings', context: 'family affection', frequency: 'high', priority: 110 },
  { text: 'I miss my family', category: 'feelings', context: 'family longing', frequency: 'high', priority: 110 },
  { text: 'My mum helps me a lot', category: 'family', context: 'mum appreciation', frequency: 'high', priority: 110 },
  { text: 'My dad makes me laugh', category: 'family', context: 'dad appreciation', frequency: 'high', priority: 110 },
  { text: 'My brother is annoying', category: 'family', context: 'sibling frustration', frequency: 'high', priority: 110 },
  { text: 'My sister is funny', category: 'family', context: 'sibling appreciation', frequency: 'high', priority: 110 },
  { text: 'I love my pet', category: 'preferences', context: 'pet affection', frequency: 'high', priority: 110 },
  { text: 'My dog is my best friend', category: 'preferences', context: 'pet bond', frequency: 'high', priority: 110 },
  { text: 'My cat is so fluffy', category: 'observations', context: 'pet description', frequency: 'high', priority: 110 },
  { text: 'I wish I had a pet', category: 'wants', context: 'pet desire', frequency: 'high', priority: 110 },
  { text: 'What\'s your pet\'s name', category: 'questions', context: 'pet inquiry', frequency: 'high', priority: 110 },
  { text: 'I like animals at the zoo', category: 'preferences', context: 'zoo interest', frequency: 'high', priority: 110 },
  { text: 'My favourite animal is a monkey', category: 'preferences', context: 'animal preference', frequency: 'high', priority: 110 },
  { text: 'I saw a bird outside', category: 'observations', context: 'nature observation', frequency: 'high', priority: 110 },
  { text: 'It\'s so pretty', category: 'observations', context: 'beauty observation', frequency: 'high', priority: 110 },
  { text: 'I want to draw it', category: 'activities', context: 'drawing intention', frequency: 'high', priority: 110 },
  { text: 'The clouds look nice today', category: 'observations', context: 'weather observation', frequency: 'high', priority: 110 },
  { text: 'I like watching the sky', category: 'preferences', context: 'sky interest', frequency: 'high', priority: 110 },
  { text: 'The sunset is beautiful', category: 'observations', context: 'sunset observation', frequency: 'high', priority: 110 },
  { text: 'The stars are out tonight', category: 'observations', context: 'night observation', frequency: 'high', priority: 110 },
  { text: 'I like looking at the moon', category: 'preferences', context: 'moon interest', frequency: 'high', priority: 110 },
