...
// Using ONLY the 5 approved colors: #2faad6, #f35e69, #8fd2b0, #fb8d98, #f9d809
export const categories: Category[] = [
  { id: 'all', label: 'All', icon: 'grid-outline', color: '#8fd2b0' },
  { id: 'keyboard', label: 'Keyboard', icon: 'keypad-outline', color: '#fb8d98' },
  { id: 'core', label: 'Core', icon: 'star-outline', color: '#2faad6' }, 
  { id: 'greetings', label: 'Greetings', icon: 'hand-left-outline', color: '#f35e69' },
  { id: 'people', label: 'People', icon: 'people-outline', color: '#fb8d98' },
  ...
  { id: 'places', label: 'Places', icon: 'location-outline', color: '#fb8d98' },
  ...
  { id: 'animals', label: 'Animals', icon: 'paw-outline', color: '#fb8d98' },
  ...
  { id: 'toys', label: 'Toys', icon: 'game-controller-outline', color: '#fb8d98' },
];
