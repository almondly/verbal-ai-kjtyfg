...
// Using ONLY the 5 approved colors: #2faad6, #ea4b49, #8fd2b0, #f271ab, #f9d809
export const categories: Category[] = [
  ...
  { id: 'greetings', label: 'Greetings', icon: 'hand-left-outline', color: '#ea4b49' },
  ...
  { id: 'food', label: 'Food', icon: 'restaurant-outline', color: '#ea4b49' },
  ...
  { id: 'routines', label: 'Routines', icon: 'time-outline', color: '#ea4b49' },
  ...
  { id: 'clothing', label: 'Clothing', icon: 'shirt-outline', color: '#ea4b49' },
