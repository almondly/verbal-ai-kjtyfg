...
export const categories: Category[] = [
  ...
  { id: 'food', label: 'Tucker', icon: 'restaurant-outline', color: '#FF6F61' }, // Australian food
  ...
  { id: 'colours', label: 'Colours', icon: 'color-palette-outline', color: '#66D9FF' }, // Australian spelling
